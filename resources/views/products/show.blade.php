...
<x-app-layout :title="$product->title">
        ...
        <article class="col-span-8 md:col-span-3 md:mt-10 mx-auto py-5 w-full h-full" style="max-width:900px">
                    ...
                    <div class="flex flex-row justify-between w-full">
                        ...
                        <h1 class="text-2xl md:text-4xl font-bold text-left text-gray-800">
                            {{ $product->title }}
                                ...
                                <livewire:like-button :key="$product->id" :$product />
                                <button>
                        ...
                        <h3 class="font-light mt-4 mb-2">Capacity</h3>
                        <div class="mb-2 text-base items-center justify-between border-t border-b border-gray-100 px-2 text-balance">
                        ...
                        <h3 class="font-light mt-4 mb-2">Application</h3>
                        <div class="mb-2 text-base items-center justify-between border-t border-b border-gray-100 px-2 text-balance">
                            @if ($product->equipment_application === null)
                            <tr>
                                <td>No Data to Display</td>
                            </tr>
                            @endif
            ...
            <div class="flex flex-col md:flex-row md:items-center items-start gap-5 w-full justify-between py-4 px-5 md:px-10 border-y-2 border-blue-200 mt-24">
