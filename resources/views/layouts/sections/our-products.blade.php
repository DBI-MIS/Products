<div class="flex flex-row lg:h-[400px] items-center gap-6">
            <div class="w-[900px] flex-grow-0">
                <p class="text-4xl font-bold mt-4">Our Products</p>
                <p class="text-lg mt-4 text-balance">Dunham-Bush is one of the biggest commercial air conditioning companies with a global network of sales and service offices. The brand has long been committed to offering clean and green heating and cooling systems to meet the specific air-conditioning needs of the customers.</p>
